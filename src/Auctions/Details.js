...
export default function Details() {
    ...
    const [auctionDetails, setAuctionDetails] = React.useState({
        start_date: "",
        end_date: "",
        auction_type: "",
        reserve_price: "",
    ...
    const handleAuctionDetails = (e) => {
        // document.getElementById("start_date").value = auctionDetails.start_date;
    ...
    return (
        <div className="flex flex-col w-full h-full p-4">
                ...
                <div className="flex flex-col w-full">
                    ...
                    <div class="relative max-w-sm">
                        ...
                        >
                            ...
                            <option value="3">Sealed Bid</option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div className="flex flex-row w-full justify-start">
                <div className="flex flex-col w-full">
                    <Typography color="gray" className="mt-1 font-bold mb-2">
                        Auction Terms
                    </Typography>
                    ...
                    <div class="relative w-full">
                        <Checkbox
                            label={
                                <Typography color="blue-gray" className="flex font-medium">
                                    I understand that I am responsible for providing accurate information about the property or tenant lease I am auctioning.
                                    <Typography
                                        as="a"
                                        href="#"
                                        color="blue"
                        ...
                        <Checkbox
                            label={
                                <Typography color="blue-gray" className="flex font-medium">
                                    I understand that potential buyers will have a due diligence period to inspect the property or tenant lease before the auction.
            ...
            <div className="flex flex-row w-full justify-start mt-10 mb-10">
                <Button
                    variant="outlined"
                    color="green"

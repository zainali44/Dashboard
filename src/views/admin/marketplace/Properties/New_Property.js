        ...
        <div className="flex justify-between">
          <div className="flex gap-x-4">
            <div>
              ...
              <p className="text-sm font-medium text-red-500 mt-4">Note : <span className="text-green-600 font-light">This Information will be displayed to all the investors and prospects, please make sure to enter the correct information.</span></p>
            </div>
          </div>
              ...
              <div className="space-y-12">
                ...
                <div className="mt-6 flex items-center justify-end gap-x-6">
                  ...
                  <button
                    ...
                    className="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-semibold leading-6 text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                    Save Changes
                  </button>
                </div>
              </div>

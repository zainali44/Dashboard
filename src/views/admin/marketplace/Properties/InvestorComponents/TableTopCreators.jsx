                ...
                return (
                  <tr {...row.getRowProps()} key={index}>
                    {row.cells.map((cell, index) => {
                      ...
                      if (cell.column.Header === "Name") {
                      ...
                      } else if (cell.column.Header === "Investment") {
                        data = (
                          <p className="text-sm font-medium text-navy-700 dark:text-white">
                            {cell.value}
                          </p>
                        );
                      } else if (cell.column.Header === "Equity") {
                        data = (
                          <p className="text-sm font-medium text-navy-700 dark:text-white">
                            {cell.value}
                          </p>
                        ...
                        data = (
                          <div className="flex items-center justify-between">
                            <button className="flex items-center justify-center rounded-full text-brand-400 dark:bg-white dark:text-brand-500 px-3 py-1 text-sm font-medium transition duration-200"
                              onClick={() => {
                                navigate(`/admin/chat`);
                              }
                              }
